...
public abstract class Analyser {
    ...
    /**
     * Return the last frame recorded by this analyser.
     *
     * @return The last frame recorded by this analyser.
     */
    public FrameRecord getLastFrame() {
        return this.getFrames().getLast();
    }
     ...
     *
     * @param frame      specific frame from {@link toxiccleanup.engine.EngineState} this is from
    ...
    /**
     * Used to store frame data describing a {@link toxiccleanup.engine.renderer.Renderable} entities state for a
    ...
    private static class FrameData implements FrameRecord {
         ...
         *                   frame)
         * @param x          horizontal coordinate of the {@link toxiccleanup.engine.renderer.Renderable} this frameData
         *                   is partially representing.
         * @param y          vertical coordinate of the {@link toxiccleanup.engine.renderer.Renderable} this frameData is
         *                   partially representing.
         * @param sprite     {@link Sprite} the current sprite being displayed for this frame of the
         *                   {@link toxiccleanup.engine.renderer.Renderable} this frame data is partially representing.
         */
