 ...
 * various {@link toxiccleanup.engine.renderer.Renderable}s believed to be using sprites from
 * SpriteGallery.letters.
 */
public class LetterAnalyser extends Analyser {
    private static final SpriteGroup art = toxiccleanup.engine.ui.SpriteGallery.letters;
