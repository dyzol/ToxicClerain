...
public class RenderableAnalyser extends Analyser {
    ...
    /**
     * Returns a String representation of which {@link toxiccleanup.engine.art.sprites.SpriteGroup} this belongs
     * to based on the first {@link Sprite} of the {@link toxiccleanup.engine.renderer.Renderable}. We assume
     * Renderables only have {@link Sprite}s from one {@link toxiccleanup.engine.art.sprites.SpriteGroup}.
     *
     * @return a String representation of which {@link toxiccleanup.engine.art.sprites.SpriteGroup} this belongs
     * to based on the first {@link Sprite} of the {@link toxiccleanup.engine.renderer.Renderable}.
     */
