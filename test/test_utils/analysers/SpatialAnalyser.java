...
public class SpatialAnalyser extends Analyser {
     ...
     */
    public SpatialAnalyser(RenderableAnalyser analyzer) {
        super(analyzer.getId(), analyzer.getFrames());
    }

    /**
     * Return a 2dVector {@link XyPair} representation of how the {@link toxiccleanup.engine.renderer.Renderable}
